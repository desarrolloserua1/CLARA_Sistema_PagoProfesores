var __DataTableArrayCheckBoxCveEscuelas = [];
    ...
    "use strict"; return {
		...
		importar: function() {
			...
			$.ajax({
				type: "POST",
				cache: false,
				url: "/CatEscuelas/Importar",
				data: "cveEscuelas="+arrChecked.join(),
				success: function (msg) {
				    $('#seccion1').unblock();
					DataTable.init();
...
var DataTable = function () {
    ...
    "use strict"; return {
        ...
        exportExcel: function (table) {
            window.location.href = '/CatEscuelas/ExportExcel';
        },
        ...
        init: function () {
            ...
            $.ajax({
                type: "GET",
                cache: false,
                url: "/CatEscuelas/CreateDataTable/",
