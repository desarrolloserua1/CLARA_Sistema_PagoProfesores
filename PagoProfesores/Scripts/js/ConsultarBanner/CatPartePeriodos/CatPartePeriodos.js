    ...
    "use strict"; return {
        consultar: function () {
            ...
            $.ajax({
                type: "GET",
                cache: false,
                url: "/CatPartePeriodos/Consultar",
        ...
        importar: function () {
            ...
            loading('loading-circle', '#seccion1', 'Importando Parte Periodos desde BANNER..');

            $.ajax({
                type: "POST",
                cache: false,
                url: "/CatPartePeriodos/Importar",
                data: "periodos=" + arrChecked.join(),
                success: function (msg) {
...
var DataTable = function () {
    ...
    "use strict"; return {
        ...
        exportExcel: function (table) {
            window.location.href = '/CatPartePeriodos/ExportExcel';
        },
        ...
        init: function () {
            ...
            $.ajax({
                type: "GET",
                cache: false,
                url: "/CatPartePeriodos/CreateDataTable/",
