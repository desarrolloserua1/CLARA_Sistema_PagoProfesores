    ...
    "use strict"; return {
        consultar: function () {
            ...
            $.ajax({
                type: "GET",
                cache: false,
                url: "/CatTiposContrato/Consultar",
        ...
        importar: function () {
            ...
            $.ajax({
                type: "POST",
                cache: false,
                url: "/CatTiposContrato/Importar",
                data: "tipoContrato=" + arrChecked.join(),
                success: function (msg) {
                    $('#seccion1').unblock();
                    DataTable.init();
...
var DataTable = function () {
    ...
    "use strict"; return {
        ...
        exportExcel: function (table) {
            window.location.href = '/CatTiposContrato/ExportExcel';
        },
        ...
        init: function () {
            ...
            $.ajax({
                type: "GET",
                cache: false,
                url: "/CatTiposContrato/CreateDataTable/",
