...
var formPage_RetencionesAnuales = function () {
    "use strict"; return {
        ...
        verRetencion: function (cve_retencion, cve_sede, anio, monto, monto_Iva, monto_IvaRet, montoIsrRet) {
			$.ajax({
				type: "GET",
				cache: false,
				url: '/ECW_RetencionesMensuales/SetRetencion',
				data: "cve_retencion=" + cve_retencion + "&cve_sede=" + cve_sede + "&mesi=1&mesf=12&anio=" + anio + "&monto=" + monto + "&monto_Iva=" + monto_Iva + "&monto_IvaRet=" + monto_IvaRet + "&montoIsrRet=" + montoIsrRet,
