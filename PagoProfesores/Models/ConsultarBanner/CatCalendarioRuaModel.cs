...
{
    public class CatCalendarioRuaModel : SuperModel
    {
        ...
        public string TABLE = "CALENDARIORUA";
        ...
        public bool addTmp()
        {
            ...
            string sql = "INSERT INTO CALENDARIORUA_TMP" +
                " (CVE_CICLO, PERIODO, DESCRIPCION, FECHA_INICIAL, FECHA_FINAL, TIPOPERIODO, FECHA_R, FECHA_M, IP, USUARIO, REGISTRADO, IMPORTADO)" +
        ...
        public bool Clean()
        {
            string sql = "DELETE FROM CALENDARIORUA_TMP WHERE USUARIO = " + sesion.pkUser;
            return db.execute(sql);
        }

        public bool exist()
        {
            TABLE = TMP ? "CALENDARIORUA_TMP" : "CALENDARIORUA";
        ...
        public bool edit()
        {
            TABLE = TMP ? "QCalendarioRuaT01" : "QCalendarioRUA01";
        ...
        public bool save()
        {
            ...
            string sql = "UPDATE " + TABLE + " SET " +
                ...
                ",FECHA_INICIAL   = CONVERT(datetime,'" + FECHA_INICIAL + "', 103)" +
                ",FECHA_FINAL     = CONVERT(datetime,'" + FECHA_FINAL + "', 103)" +
        ...
        public bool add()
        {
            ...
            string sql = "INSERT INTO CALENDARIORUA" +
        ...
        public bool mark()
        {
            ...
            string sql = "UPDATE CALENDARIORUA_TMP SET REGISTRADO=1, IMPORTADO=1, FECHA_M='" + FECHA_M + "' WHERE CVE_CICLO='" + CVE_CICLO + "' AND PERIODO = '" + PERIODO + "'";
            return db.execute(sql);
        }
